...
$response = Http::withoutVerifying()->timeout(150)->post($url, [
    ...
    'generationConfig' => [
        'temperature' => 0.7,
        // Wait, maybe the key is not imageConfig but something else?
        // Or maybe it simply is not supported by generateContent in PHP?
        // Let's test standard payload first.
