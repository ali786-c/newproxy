...
Route::middleware(['auth:sanctum', 'role:admin', 'throttle:60,1'])->prefix('admin')->group(function () {
    ...
    Route::post('/blog/automation/telegram-test', function(\App\Services\TelegramService $telegram) {
    ...
    Route::post('/blog/automation/linkedin-test', [\App\Http\Controllers\AutoBlogController::class, 'testLinkedIn']);
    Route::post('/blog/automation/linkedin-share-post', [\App\Http\Controllers\AutoBlogController::class, 'sharePostToLinkedIn']);
